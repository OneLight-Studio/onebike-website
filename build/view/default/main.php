...
<section id="stations">
    <div class="inner-content">
        <article>
            <img src="<?php Html::img('stations'); ?>" alt="Stations libre service" title="Stations libre service"/>
            <div class="text-part">
                <h2>
...
<section id="search">
    <div class="inner-content">
        <article>
            <img src="<?php Html::img('search'); ?>" alt="OneBile recherche facile" title="OneBile recherche facile"/>
            <div class="text-part">
                <h2>
    ...
    <div class="inner-content">
        <article>
            ...
            <div id="download-links">
                ...
                <a target="_blank" href="https://itunes.apple.com/fr/app/onebike/id718967693?mt=8&uo=4"><img src="<?php Html::img('appstore'); ?>" alt="OneBike sur Appstore" title="OneBike sur Appstore"/> App Store</a>
            </div>
        </article>
    </div>
</section>
    ...
    <div class="inner-content">
        <article>
            <div class="content-clearfix">
                <img src="<?php Html::img('onelightstudio'); ?>" alt="OneLight Studio" title="OneLight Studio"/>
                <div class="text-part">
                    <h2>
                        À propos
                    </h2>
                    ...
                    <div class="social-networks">
                        <a target="_blank" href="https://www.facebook.com/pages/Onelight-Studio/120029234874979">f</a>
                        <a target="_blank" href="https://twitter.com/OneLight_Studio">t</a>
                        <a target="_blank" href="https://plus.google.com/117913891675582515724/posts">g</a>
                    </div>
                </div>
            </div>
        </article>
...
<nav id="nav-right">
    <ul>
        <li id="onebike-menu">OneBike</li>
        <li id="stations-menu">Stations</li>
        <li id="search-menu">Recherche</li>
        <li id="winner-menu">Grand prix</li>
        <li id="download-menu">Téléchargement</li>
        <li id="about-menu">À propos</li>
    </ul>
</nav>